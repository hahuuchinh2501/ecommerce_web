    ...
    <div class="container-fluid p-0">
        ...
        <div class="container">
            <form action="" method="post">
                <?php
// Trong cart.php, phần xử lý hiển thị giỏ hàng
global $con;
...
if (isset($_SESSION['user_id'])) {
    ...
    $cart_query = "SELECT * FROM `cart_details` WHERE ip_address='$get_ip_add' AND user_id=$user_id";
    ...
    if ($result_count > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        while ($row_product_price = mysqli_fetch_array($result_products)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="qty[<?php echo $product_id; ?>]" class="cart-form-input" min="1" value="<?php echo $quantity; ?>">
                                </td>
        ...
        <!-- Hiển thị tổng giá tiền và các nút thao tác -->
        <div class="cart-summary">
            ...
            <div class="cart-actions">
                ...
                <a href="./users_area/checkout.php" class="btn-checkout">Proceed to Checkout</a>
            </div>
        </div>
        <?php
    } else {
    ...
    <div class="cart-empty">
        ...
        <h2 class="text-center">Please login to view your cart</h2>
        <p class="text-center">You need to login to see and manage your shopping cart.</p>
        <div class="text-center mt-4">
            <a href="./users_area/user_login.php" class="btn btn-primary">Login Now</a>
            <input type="submit" value="Continue Shopping" class="btn-continue ml-2" name="continue_shopping">
        </div>
    </div>
    <?php
}
...
if (isset($_POST['update_cart']) && isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    foreach ($_POST['qty'] as $product_id => $quantity) {
        if ($quantity > 0) {
            $update_cart = "UPDATE cart_details SET quantity=$quantity WHERE ip_address='$get_ip_add' AND product_id='$product_id' AND user_id=$user_id";
...
if (isset($_POST['remove_cart']) && isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
