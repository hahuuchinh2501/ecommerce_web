            ...
            <div class="row">
                <form action="" method="post">
                    ...
                    <div class="d-flex mb-5">
                        ...
                        <a href='index.php' class='bg-info px-3 py-2 border-0 mx-3 text-decoration-none text-dark'><button>
                            Continue Shopping
                        </button></a>
                         <a href='#'><button class='bg-secondary p-3 py-2 border-0 text-light'>checkout</button></a>";
                        } else {
                            echo "  <a href='index.php' class='bg-info px-3 py-2 border-0 mx-3 text-decoration-none text-dark'>
                            Continue Shopping ";
                        }
