...
function cart_item() {
    ...
    if(isset($_SESSION['username'])) {
        ...
        $select_query = "SELECT * FROM `cart_details` WHERE ip_address='$get_ip_add' AND user_id IS NULL";
    }
...
function total_cart_price() {
    ...
    if(isset($_SESSION['username'])) {
        ...
        $cart_query = "SELECT * FROM `cart_details` WHERE ip_address='$get_ip_add' AND user_id IS NULL";
    }
