...
function get_user_order_details(){
    ...
    // Check if user_id is provided directly
    ...
    // Now use the correct user_id to fetch orders
    if(!isset($_GET['edit_account']) && !isset($_GET['my_orders']) && !isset($_GET['delete_account'])){
        ...
        if($row_count > 0){
            ...
            <p class='text-center'><a href='profile.php?my_orders&user_id=$user_id' class='text-dark'>Order 
            Details</a></p>";
        } else {
