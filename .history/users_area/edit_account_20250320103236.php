...
<body>
    <h3 class=" mb-4" style="color: palevioletred">Edit Account</h3>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="submit" value="Update" class="bg-black py-2 px-3 border-1 color " style="text-align: center;" name="user_update">
</form>
</body>
</html>