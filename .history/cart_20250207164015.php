        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex mb-5">
                    ...
                    <a href="index.php"><button class="bg-info px-2 border-0 mx-3">continue shopping</button></a>
                    <a href="#"><button class="bg-secondary px-2 border-0 text-light">checkout</button></a>
                </div>
            </div>
        </div>
