            ...
            <div class="row">
                <form action="" method="post">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                while ($row_product_price = mysqli_fetch_array($result_products)) {
                                    ...
                                    <tr>
                                        ...
                                        $ordered_quantity = $order_quantity_row ? $order_quantity_row['quantity'] : 0;
                                        ?>

                                        <td><?php echo $price_table ?></td>
                                        <td><?php echo $ordered_quantity ?></td>
                                        <td><input type="checkbox" name="removeitem[]" <?php echo $product_id ?>></td>
                                        <td>
                    ...
                    <div class="d-flex mb-5">
                        <h4 class="px-3 py-2">total: <strong><?php echo $total_price ?> VND</strong></h4>
                        <a href="index.php"><button class="bg-info px-3 py-2 border-0 mx-3">continue
                                shopping</button></a>
        ...
        function remove_cart_item()
        {
            ...
            if (isset($_POST['remove_cart']) && isset($_POST['removeitem']) && is_array($_POST['removeitem'])) {
                foreach ($_POST['removeitem'] as $remove_id) {
                    if (!empty($remove_id) && is_numeric($remove_id)) { // Kiểm tra ID hợp lệ
